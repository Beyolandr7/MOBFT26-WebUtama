...
import { assignments, assignmentSubmissions, users, participants, attendanceSessions, attendances, groupTypes, gameCredentials, groups, passwordChanges, violations, violationTypes, groupparticipant, groupuser, permissions, rolepermissions, roles, userroles } from "./schema";
...
export const gameCredentialsRelations = relations(gameCredentials, ({one}) => ({
	participant: one(participants, {
...
export const passwordChangesRelations = relations(passwordChanges, ({one}) => ({
	user: one(users, {
...
export const groupparticipantRelations = relations(groupparticipant, ({one}) => ({
	group: one(groups, {
